...
var datamatrix : ChartMatrix = null
var dataset : Array = []
...
func build_dataset_from_matrix(datamatrix : ChartMatrix, headers : PackedStringArray, labels : PackedStringArray) -> Array:
...
func get_datamatrix() -> ChartMatrix:
	return datamatrix
...
func columns(headers : PackedStringArray) -> ChartMatrix:
	var values : Array = []
...
func rows(labels : Array) -> ChartMatrix:
	var values : Array = []
	for label in labels:
		values.append(get_row(label))
	return ChartMatrix.new(values)
